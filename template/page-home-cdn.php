<?php
/**
 * Template Name: Yani Content Home (CDN)
 * Template Post Type: page
 * Description: Trang chủ Yani Content Master - Sử dụng CDN URL cho assets
 * 
 * CÁCH DÙNG CDN (DỄ NHẤT):
 * 1. Upload tất cả file assets lên CDN (Cloudinary, Imgur, S3, etc.)
 * 2. Thay đổi CDN_URL dưới đây
 * 3. Không cần copy file assets vào server
 */
...
define('CDN_URL', 'https://cdn.yourdomain.com/yani-assets/');

// Hoặc sử dụng một trong các CDN phổ biến:
// Cloudinary: https://res.cloudinary.com/your-cloud/image/upload/v1234567890/
...
<div class="yani-home-container">
    ...
    <section class="hero-section">
        ...
        <div class="hero-spotlight">
            ...
            <img class="spotlight-img" src="<?php echo CDN_URL; ?>516-768.svg" alt="Spotlight">
        </div>
        ...
        <div class="hero-spotlight-right">
            ...
            <img class="spotlight-img-right" src="<?php echo CDN_URL; ?>516-780.svg" alt="Spotlight Right">
        </div>
    </section>
    ...
    <section class="partners-section">
        ...
        <div class="partners-grid">
            ...
            <div class="partner-card">
                <img class="partner-icon" src="<?php echo CDN_URL; ?>516-792.svg" alt="Xây dựng & Nội thất">
            ...
            <div class="partner-card">
                <img class="partner-icon" src="<?php echo CDN_URL; ?>516-799.svg" alt="B2B Services">
            ...
            <div class="partner-card">
                <img class="partner-icon" src="<?php echo CDN_URL; ?>516-804.svg" alt="Y tế & Sức khỏe">
